...
static rosidl_typesupport_introspection_c__MessageMember more_interfaces__msg__AddressBook__rosidl_typesupport_introspection_c__AddressBook_message_member_array[7] = {
  {
    "first_name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(more_interfaces__msg__AddressBook, sag_teker_hiz),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(more_interfaces__msg__AddressBook, sol_teker_hiz),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(more_interfaces__msg__AddressBook, linear_actuator),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
