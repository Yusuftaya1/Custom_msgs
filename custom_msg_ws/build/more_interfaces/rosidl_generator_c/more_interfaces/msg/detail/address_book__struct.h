...
enum
{
  more_interfaces__msg__AddressBook__PHONE_TYPE_MOBILE = 0
};

/// Constant 'PHONE_TYPE_HOME'.
enum
{
  more_interfaces__msg__AddressBook__PHONE_TYPE_HOME = 1
};

/// Constant 'PHONE_TYPE_WORK'.
enum
{
  more_interfaces__msg__AddressBook__PHONE_TYPE_WORK = 2
};
