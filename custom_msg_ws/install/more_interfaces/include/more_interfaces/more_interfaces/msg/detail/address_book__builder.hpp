...
class Init_AddressBook_linear_actuator
{
public:
  explicit Init_AddressBook_linear_actuator(::more_interfaces::msg::AddressBook & msg)
  : msg_(msg)
  {}
  ::more_interfaces::msg::AddressBook linear_actuator(::more_interfaces::msg::AddressBook::_linear_actuator_type arg)
  {
...
class Init_AddressBook_sol_teker_hiz
{
public:
  explicit Init_AddressBook_sol_teker_hiz(::more_interfaces::msg::AddressBook & msg)
  : msg_(msg)
  {}
  Init_AddressBook_linear_actuator sol_teker_hiz(::more_interfaces::msg::AddressBook::_sol_teker_hiz_type arg)
  {
    msg_.sol_teker_hiz = std::move(arg);
    return Init_AddressBook_linear_actuator(msg_);
  }
...
class Init_AddressBook_sag_teker_hiz
{
public:
  explicit Init_AddressBook_sag_teker_hiz(::more_interfaces::msg::AddressBook & msg)
  : msg_(msg)
  {}
  Init_AddressBook_sol_teker_hiz sag_teker_hiz(::more_interfaces::msg::AddressBook::_sag_teker_hiz_type arg)
  {
    msg_.sag_teker_hiz = std::move(arg);
    return Init_AddressBook_sol_teker_hiz(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_AddressBook_sag_teker_hiz phone_type(::more_interfaces::msg::AddressBook::_phone_type_type arg)
  {
    msg_.phone_type = std::move(arg);
    return Init_AddressBook_sag_teker_hiz(msg_);
  }
